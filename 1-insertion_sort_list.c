...
/**
 * insertion_sort_list - sorts a doubly linked list of int in ascending
 * order using an insertion sort algorithm
 * @list: doubly linked list of int to be sorted
 */
void insertion_sort_list(listint_t **list)
{
	...
	/* dance begin with 1st from house left following */
	follow = (*list);
